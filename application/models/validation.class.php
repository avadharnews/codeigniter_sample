...
$input = preg_replace('/[^a-zA-Z0-9]/s', '', $input);
	 ...
	 */
	public static function checkLength($value, $maxLength, $minLength = 10)
	{
	...
	/* checks id address valid or not
	*/
	public static function ipvalidation($ip)
	{

		if (!filter_var($ip, FILTER_VALIDATE_IP, FILTER_FLAG_IPV6) === false || !filter_var($ip, FILTER_VALIDATE_IP) === false) {
			return true;
		} else {
			return false;
		}
	}
		/*validation using filter mathod
		with sanitizing
	*/
	...
	/*this fuction is used removing html ,xml,php tags*/
	public static function sanitizestring($input)
	{
		return strip_tags($input);
	}
	
	public static function remove_char($text)
	{
